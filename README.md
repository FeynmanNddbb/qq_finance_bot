# QQ 新闻机器人（qq_news_bot）

自动抓取财经新闻 → 调用大模型做 A 股分析 → 定时推送到 QQ 群的机器人。
...
- **多模型分析**：通过环境变量一键切换 智谱 GLM、OpenAI GPT、Anthropic Claude
...
```bash
git clone https://github.com/<your-name>/qq_news_bot.git
cd qq_news_bot
